...
def print_outro(count):
    print('###############################################################################')
    print('FILE CHECKER DONE')
    print('FILES TO BACKUP: ', count)
    print('###############################################################################')
...
if __name__ == '__main__':
    ...
    file_count = check_files(backup_date, base_path)
    write_backup_date()
    print_outro(file_count)
